...
TRAIN_END_DATE = '2025-08-15'
TEST_START_DATE = '2025-07-01'
TEST_END_DATE = '2025-07-30'  # Up to near current date
# TICKER_LIST = ["BTC-USD", "ETH-USD"]
data_source = "yfinance"  # Key-free option
...
def train(start_date, end_date, ticker_list, data_source, time_interval,
    ...
    if drl_lib == 'elegantrl':
        ...
        model_config['lr'] = rllib_params['learning_rate']
        model_config['train_batch_size'] = rllib_params['batch_size']
